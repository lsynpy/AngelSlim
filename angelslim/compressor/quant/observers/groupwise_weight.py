...
class AbsMaxGroupWiseWeightObserver(BaseObserver):
    ...
    def _cal_abs_max(self, inputs):
        assert self._group_size == 64 or self._group_size == 128, "group_size only support 64 or 128"
        assert inputs.shape[1] % self._group_size == 0, "group_size must be a factor of input channels"
